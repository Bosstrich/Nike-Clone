    ...
    return ( 
        <section id='home' className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container'>   
                <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
                    ...
                    <p className='font-montserrat text-slate-grey text-lg leading-8 mt-6 mb-14 sm:max-w-sm'>Discover stylish Nike arrivals,
                ...
                <div className='relative flex flex-1 justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-center bg-cover'>
                    <img className='object-contain relative z-10 '
                        src={bigShoeImg} alt="shoe image" width={610} height={500} />
